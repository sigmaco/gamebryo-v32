#pragma once
#if !defined(SWIGLUARUNTIME_H)
#define SWIGLUARUNTIME_H
/* ----------------------------------------------------------------------------
...
#pragma warning(disable : 4505) // Ignore warnings about unreferences functions being removed. 
#endif
...
// asaarela 09/30/08: compiling Lua as C++, remove extern "C"
//#ifdef __cplusplus
//extern "C" {
//#endif
...
SWIGRUNTIME const char *SWIG_Lua_typename(lua_State *L, int tp)
{
  ...
  {
    // asaarela 10/27/09: Fixed indexing error when retrieving user data.
...
{
// asaarela 12/1/2008 - Removed dead code from the 1.3.34 source base.
